...
import { MidnightNetworkBadge } from "@src/components/layout/MidnightNetworkBadge";
import {
	heroImageUrl,
	resolveSectionHero,
...
const sections: Array<{
	...
	{ key: "onramp", label: "Midnight Wallet", icon: ArrowsRightLeftIcon },
